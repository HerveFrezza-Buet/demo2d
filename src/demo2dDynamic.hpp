...
namespace demo2d {
  namespace dyn {
    ...
    class circle : private demo::dyn::linear<demo::dyn::bound::wrap> {
    private:
      ...
      void update() {
	double angle = this->demo::dyn::linear<demo::dyn::bound::wrap>::operator()();
	...
	: demo::dyn::linear<demo::dyn::bound::wrap>(init_angle_deg, -180, 180, dangle_deg), r(r) {
	update();
      }
      ...
      void operator++(int){++(*this);}
      void operator++() {
	this->demo::dyn::linear<demo::dyn::bound::wrap>::operator++();
	update();
      }
    };
    ...
    public:
      ...
      const demo2d::Point& operator()() const {return point;}
      void operator++(int){++(*this);}
